...
//    @JsonProperty(access = JsonProperty.Access.READ_ONLY)
    ...
    public User(@Email @NotBlank String email, @NotBlank String firstName, String lastName, @NotBlank @Size(min = 5) String password, boolean enabled, @NotNull Date registered, Set<Role> roles, List<Car> cars) {
        this.email = email;
        this.firstName = firstName;
        this.lastName = lastName;
        this.password = password;
